...
const Modal = props => {
  return (
    <div className="modal">
      ...
      <p>Quench your thirst on drinks served up by <a href="https://www.thecocktaildb.com/api.php" target='_blank'>TheCocktailDB</a> API.*</p>
      ...
      <p><small>* All results are retrieved from <a href="https://www.thecocktaildb.com/api.php" target='_blank'>TheCocktailDB</a> on an "as is" basis. Please forgive any errors in spelling, grammar, syntax, or mixology.</small></p>
    </div>
  );
};
